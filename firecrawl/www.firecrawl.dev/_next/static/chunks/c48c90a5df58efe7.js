...
! function() {
    try {
        var e = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof global ? global : "undefined" != typeof window ? window : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && ((e._debugIds || (e._debugIds = {}))[n] = "6386ebba-9de4-54a4-7a17-9954037aaf28")
    } catch (e) {}
}();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 998690, e => {
    ...
    function C({
        fill: e = "var(--heat-100)",
        innerFillColor: C = "var(--background-base)",
        ...r
    }) {
    ...
    function l({
        ...
        let x = u || i || s || n || l,
            ...
            v = h || c || o || a || l;
        return (0, t.jsxs)("div", {
            className: (0, C.cn)(e, "pointer-events-none contain-[layout,paint] curvy-rect"),
            ...p,
            children: [x && (0, t.jsx)(r, {
    ...
    e.s(["Connector", 0, ({
        ...
        xmlns: "http://www.w3.org/2000/svg",
        ...r,
        className: (0, C.cn)("pointer-events-none contain-[layout,paint] absolute", e),
        children: (0, t.jsx)("path", {
    ...
    function l(e, t) {
        ...
        return (0, r.useCallback)(r => {
            if (null === r) {
                ...
                let t = l.current;
                t && (l.current = null, t())
            } else e && (C.current = n(e, r)), t && (l.current = n(t, r))
        }, [e, t])
    }
    ...
    function n(e, t) {
        if ("function" != typeof e) return e.current = t, () => {
            ...
            let C = e(t);
            return "function" == typeof C ? C : () => e(null)
        }
        ...
        value: !0
    }), Object.assign(C.default, C), t.exports = C.default)
}, 444534, (e, t, C) => {
    "use strict";
    Object.defineProperty(C, "__esModule", {
        value: !0
    ...
    for (var l in r) Object.defineProperty(C, l, {
        enumerable: !0,
        get: r[l]
    });
    let n = e.r(744066),
    ...
    function m(t) {
        var C;
        let r, l, n, [o, m] = (0, s.useOptimistic)(d.IDLE_LINK_STATUS),
            v = (0, s.useRef)(null),
            {
                href: g,
                as: j,
        ...
        r = w, _ && ("string" == typeof r || "number" == typeof r) && (r = (0, a.jsx)("a", {
            children: r
        }));
        let S = s.default.useContext(i.AppRouterContext),
            A = !1 !== y,
            O = !1 !== y ? null === (C = y) || "auto" === C ? p.FetchStrategy.PPR : p.FetchStrategy.Full : p.FetchStrategy.PPR,
            {
                href: F,
                as: B
            } = s.default.useMemo(() => {
        ...
        if (_) {
            ...
            l = s.default.Children.only(r)
        }
        let D = _ ? l && "object" == typeof l && l.ref : L,
            I = s.default.useCallback(e => (null !== S && (v.current = (0, d.mountLinkInstance)(e, F, S, O, A, m)), () => {
                v.current && ((0, d.unmountLinkForCurrentNavigation)(v.current), v.current = null), (0, d.unmountPrefetchableInstance)(e)
            }), [A, F, S, O, m]),
            U = {
                ref: (0, c.useMergedRef)(I, D),
                onClick(t) {
                    _ || "function" != typeof z || z(t), _ && l.props && "function" == typeof l.props.onClick && l.props.onClick(t), !S || t.defaultPrevented || function(t, C, r, l, n, a, o) {
                        if ("u" > typeof window) {
                            let i, {
                                nodeName: c
                            } = t.currentTarget;
                            ...
                            if (!(0, h.isLocalURL)(C)) {
                                n && (t.preventDefault(), location.replace(C));
                                return
                            }
                            ...
                            s.default.startTransition(() => {
                                u(r || C, n ? "replace" : "push", a ? ? !0, l.current)
                            })
                        }
                    }(t, F, B, v, M, k, H)
                },
                onMouseEnter(e) {
                    _ || "function" != typeof R || R(e), _ && l.props && "function" == typeof l.props.onMouseEnter && l.props.onMouseEnter(e), S && A && (0, d.onNavigationIntent)(e.currentTarget, !0 === E)
                },
                onTouchStart: function(e) {
                    _ || "function" != typeof V || V(e), _ && l.props && "function" == typeof l.props.onTouchStart && l.props.onTouchStart(e), S && A && (0, d.onNavigationIntent)(e.currentTarget, !0 === E)
                }
            };
        return (0, u.isAbsoluteUrl)(B) ? U.href = B : _ && !N && ("a" !== l.type || "href" in l.props) || (U.href = (0, f.addBasePath)(B)), n = _ ? s.default.cloneElement(l, U) : (0, a.jsx)("a", { ...P,
            ...U,
            children: r
        }), (0, a.jsx)(b.Provider, {
            value: o,
    ...
    e.r(444534);
    let b = (0, s.createContext)(d.IDLE_LINK_STATUS),
        v = () => (0, s.useContext)(b);
    ("function" == typeof C.default || "object" == typeof C.default && null !== C.default) && void 0 === C.default.__esModule && (Object.defineProperty(C.default, "__esModule", {
        value: !0
    }), Object.assign(C.default, C), t.exports = C.default)
    ...
    function l({
        ...
        let [s, o] = (0, C.useState)(e), [i, c] = (0, C.useState)(!1), u = (0, C.useRef)(void 0), f = (0, C.useRef)(void 0), [d, h] = (0, C.useState)(!1), p = (0, C.useRef)(null);
        return (0, C.useEffect)(() => {
            ...
            if (p.current) {
                ...
                p.current.textContent = s, p.current.style.width = `${t}px`, p.current.style.display = "inline-block", p.current.style.visibility = "visible"
            }
        }, [e]), (0, C.useEffect)(() => {
            if (!i || !a || d) return;
            o(Array(e.length).fill(0).map(() => r[Math.floor(Math.random() * r.length)]).join(""));
            let t = setTimeout(() => {
                f.current = Date.now();
                let t = () => {
                    let C = Math.min((Date.now() - (f.current || 0)) / (1e3 * n), 1);
                    if (C < 1) {
                        let l = Math.floor((1 - C) * e.length),
                            n = e.length - l;
                        o(e.slice(0, n) + Array(l).fill(0).map(() => r[Math.floor(Math.random() * r.length)]).join("")), u.current = setTimeout(t, 30)
                    } else o(e), h(!0)
                };
                t()
            }, 1e3 * l);
            return () => {
                clearTimeout(t), u.current && clearTimeout(u.current)
            }
        }, [e, l, n, a, d, i]), (0, t.jsx)("span", {
            ref: p,
        ...
        return (0, C.useEffect)(() => {
            ...
            return e.A(101624).then(({
                ...
                let {
                    ...
                    textWidth: r,
                    textHeight: a
                } = (0, l.setupAsciiCanvas)(s.current, e[0], 10, 12.5, "Geist Mono, monospace");
                (0, l.renderAsciiFrame)(C, e[0], r, a, 10, 12.5, "Geist Mono, monospace", "#FA5D19");
                let i = 0,
                    c = !0;
                t = (0, n.setIntervalOnVisible)({
                    ...
                    callback: () => {
                        ...
                        i < 0 || (0, l.renderAsciiFrame)(C, e[i], r, a, 10, 12.5, "Geist Mono, monospace", "#FA5D19")
                    },
                    interval: 40
                })
            }), () => t ? .()
            ...
            ref: o,
            ...a,
            className: (0, r.cn)("w-[720px] h-[400px] absolute gap-16 pointer-events-none select-none hidden lg:flex", a.className),
    ...
    e.s(["AsciiExplosion", 0, a, "default", 0, a])
}, 636768, e => {
    "use strict";
    var t = e.i(253719),
        C = e.i(730592),
    ...
    function i({
        ...
        return (0, t.jsx)("svg", {
            className: (0, o.cn)("transition-all", "right" === e ? "group-hover:translate-x-8" : "group-hover:-translate-x-8", "right" === e ? "" : "rotate-180", r),
            fill: "none",
            height: C,
            width: C,
            viewBox: "0 0 20 20",
    ...
    function u() {
        ...
        let f = (0, C.useMemo)(() => (0, t.jsxs)("div", {
            className: "relative",
            children: [(0, t.jsx)("div", {
                ...
                children: [(0, t.jsx)("div", {
                    ...
                    children: (0, t.jsx)("div", {
                        ...
                        children: (0, t.jsx)(a.AsciiExplosion, {
        ...
        return (0, t.jsx)("div", {
            ...
            children: (0, t.jsxs)("div", {
                className: "w-full max-w-[400px] mx-auto relative h-full flex flex-col",
                children: [(0, t.jsx)("div", {
                    ...
                    children: [f, (0, t.jsxs)("div", {
                        className: "relative bg-red-50/50",
                        children: [(0, t.jsx)("div", {
                            className: "px-16 py-32 text-center",
                            children: (0, t.jsx)("h1", {
                                className: "font-mono text-heading-xl text-primary",
                        ...
                        children: [(0, t.jsxs)("div", {
                            ...
                            children: [(0, t.jsx)("p", {
                                className: "text-label-medium text-secondary mb-12",
                                children: "Searching for something? Try one of the links below:"
                            }), (0, t.jsx)("ul", {
                                className: "list-disc list-inside space-y-8",
                                children: [{
                                    label: "Firecrawl Blog",
                                    href: "/blog"
                                }, {
                                    label: "Firecrawl Playground",
                                    href: "/playground"
                                }, {
                                    label: "Firecrawl Docs",
                                    href: "https://docs.firecrawl.dev"
                                }, {
                                    label: "Firecrawl Pricing",
                                    href: "/pricing"
                                }, {
                                    label: "Firecrawl Use Cases",
                                    href: "/use-cases"
                                }, {
                                    label: "Firecrawl Changelog",
                                    href: "/changelog"
                                }, {
                                    label: "Firecrawl GitHub Repository",
                                    href: "https://github.com/firecrawl/firecrawl"
                                }, {
                                    label: "Web Extraction Glossary",
                                    href: "/glossary"
                                }].map(({
                                    label: e,
                                    href: C
                                    ...
                                    children: (0, t.jsx)(c.default, {
                                        href: C,
                                        className: "text-label-medium text-heat-100 hover:underline",
                                        children: e
                                    })
                                }, C))
                            })]
                        ...
                        children: [(0, t.jsx)("div", {
                            ...
                            children: (0, t.jsxs)("button", {
                                className: "group inline-flex items-center justify-center rounded-full font-medium transition-all duration-200 h-48 px-24 text-label-large gap-10 bg-surface text-accent-black border border-black-alpha-8 hover:bg-black-alpha-4 hover:border-black-alpha-12 active:scale-[0.98] w-full",
                                onClick: () => e.push("/"),
                                children: [(0, t.jsx)(i, {
                                    direction: "left",
                                    className: "-ml-2"
    ...
    e.s(["default", () => u], 636768)
}, 101624, e => {
    e.v(e => Promise.resolve().then(() => e(764376)))
}]);

//# debugId=6386ebba-9de4-54a4-7a17-9954037aaf28
//# sourceMappingURL=46255a8f9465758f.js.map