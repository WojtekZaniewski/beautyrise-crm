...
! function() {
    try {
        var e = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof global ? global : "undefined" != typeof window ? window : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && ((e._debugIds || (e._debugIds = {}))[n] = "47a866aa-389b-7e7e-a371-7a4fbb2b0de9")
    } catch (e) {}
}();
(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 323576, e => {
    "use strict";
    var t = e.i(253719),
        s = e.i(420851);
    ...
    function l({
        ...
        let f = d || C || r || i || l,
            ...
            v = h || c || o || n || l;
        return (0, t.jsxs)("div", {
            className: (0, s.cn)(e, "pointer-events-none contain-[layout,paint] curvy-rect"),
            ...p,
            children: [f && (0, t.jsx)(a, {
    ...
    e.s(["Connector", 0, ({
        ...
        xmlns: "http://www.w3.org/2000/svg",
        ...a,
        className: (0, s.cn)("pointer-events-none contain-[layout,paint] absolute", e),
        children: (0, t.jsx)("path", {
    ...
    function s({
        fill: e = "var(--heat-100)",
        innerFillColor: s = "var(--background-base)",
        ...a
    }) {
        return (0, t.jsx)("svg", { ...a,
            height: "600",
            ...
            children: (0, t.jsxs)("g", {
                children: [(0, t.jsx)("g", {
                    transform: " translate(293.035, 553.013) scale(0.97724, 0.97724) translate(-533.035, -800.013)",
                    children: (0, t.jsx)("path", {
                    ...
                    transform: " translate(300, 470.504) scale(0.9650799999999999, 0.9650799999999999) translate(-510.283, -685.815)",
                    children: (0, t.jsx)("path", {
        ...
        getSnapshotBeforeUpdate(e) {
            ...
            if (t && e.isPresent && !this.props.isPresent) {
                let e = t.offsetParent,
                    s = (0, r.isHTMLElement)(e) && e.offsetWidth || 0,
                    a = this.props.sizeRef.current;
                a.height = t.offsetHeight || 0, a.width = t.offsetWidth || 0, a.top = t.offsetTop, a.left = t.offsetLeft, a.right = s - a.width - a.left
            }
            return null
        }
        componentDidUpdate() {}
    ...
    function d({
        ...
        return (0, o.useInsertionEffect)(() => {
            ...
            let x = "left" === a ? `left: ${C}` : `right: ${c}`;
            n.current.dataset.motionPopId = i;
            let u = document.createElement("style");
            d && (u.nonce = d);
            let h = l ? ? document.head;
    ...
    let m = ({
        ...
        let [b, v] = (0, h.usePresence)(d), g = (0, s.useMemo)(() => f(e), [e]), j = d && !b ? [] : g.map(p), w = (0, s.useRef)(!0), N = (0, s.useRef)(g), y = (0, l.useConstant)(() => new Map), [k, M] = (0, s.useState)(g), [_, V] = (0, s.useState)(g);
        (0, i.useIsomorphicLayoutEffect)(() => {
            w.current = !1, N.current = g;
        ...
        if (g !== k) {
            ...
            for (let t = 0; t < _.length; t++) {
                let s = _[t],
                    a = p(s);
                j.includes(a) || (e.splice(t, 0, s), H.push(s))
            }
            return "wait" === c && H.length && (e = H), V(f(e)), M(g), null
        }
        let {
            forceRender: z
        } = (0, s.useContext)(a.LayoutGroupContext);
        return (0, t.jsx)(t.Fragment, {
            children: _.map(e => {
                let s = p(e),
                    a = (!d || !!b) && (g === _ || j.includes(s));
                return (0, t.jsx)(x, {
                    isPresent: a,
    ...
    function l({
        ...
        let [r, o] = (0, s.useState)(e), [C, c] = (0, s.useState)(!1), d = (0, s.useRef)(void 0), x = (0, s.useRef)(void 0), [u, h] = (0, s.useState)(!1), p = (0, s.useRef)(null);
        return (0, s.useEffect)(() => {
            c(!0)
        }, []), (0, s.useEffect)(() => {
            if (p.current) {
                p.current.style.visibility = "hidden", p.current.textContent = e;
                let t = p.current.offsetWidth;
                p.current.textContent = r, p.current.style.width = `${t}px`, p.current.style.display = "inline-block", p.current.style.visibility = "visible"
            }
        }, [e]), (0, s.useEffect)(() => {
            if (!C || !n || u) return;
            o(Array(e.length).fill(0).map(() => a[Math.floor(Math.random() * a.length)]).join(""));
            let t = setTimeout(() => {
                x.current = Date.now();
                let t = () => {
                    let s = Math.min((Date.now() - (x.current || 0)) / (1e3 * i), 1);
                    if (s < 1) {
                        let l = Math.floor((1 - s) * e.length),
                            i = e.length - l;
                        o(e.slice(0, i) + Array(l).fill(0).map(() => a[Math.floor(Math.random() * a.length)]).join("")), d.current = setTimeout(t, 30)
                    } else o(e), h(!0)
                };
                t()
            }, 1e3 * l);
        ...
        return (0, s.useEffect)(() => {
            ...
            return e.A(101624).then(({
                ...
                let {
                    ...
                    textWidth: a,
                    textHeight: n
                } = (0, l.setupAsciiCanvas)(r.current, e[0], 10, 12.5, "Geist Mono, monospace");
                (0, l.renderAsciiFrame)(s, e[0], a, n, 10, 12.5, "Geist Mono, monospace", "#FA5D19");
                let C = 0,
                    c = !0;
                t = (0, i.setIntervalOnVisible)({
                    ...
                    callback: () => {
                        ...
                        C < 0 || (0, l.renderAsciiFrame)(s, e[C], a, n, 10, 12.5, "Geist Mono, monospace", "#FA5D19")
                    },
                    interval: 40
                })
            }), () => t ? .()
            ...
            ref: o,
            ...n,
            className: (0, a.cn)("w-[720px] h-[400px] absolute gap-16 pointer-events-none select-none hidden lg:flex", n.className),
    ...
    function h({
        ...
        let j = async () => {
                let t = `Error: ${e.message||"An unexpected error occurred"}${e.digest?`
ID: ${e.digest}`:""}${e.stack?`

Stack:
${e.stack}`:""}`;
                try {
                    await navigator.clipboard.writeText(t), m(!0), g.current && clearTimeout(g.current), g.current = setTimeout(() => {
                        m(!1)
                    }, 2e3)
                } catch (e) {
                ...
                children: [(0, t.jsx)("div", {
                    ...
                    children: [(0, t.jsx)("div", {
                        ...
                        children: (0, t.jsx)("div", {
                            ...
                            children: (0, t.jsx)(s.AsciiExplosion, {
        ...
        return (0, t.jsxs)("div", {
            className: "h-screen bg-background-base relative flex flex-col overflow-hidden",
            children: [(0, t.jsxs)("div", {
                className: "w-full pt-108 max-w-[400px] mx-auto relative flex-col h-full hidden lg:flex",
                children: [(0, t.jsx)("div", {
                    className: "absolute left-0 top-0 bottom-0 w-1 bg-border-faint"
                }), (0, t.jsx)("div", {
                    className: "absolute right-0 top-0 bottom-0 w-1 bg-border-faint"
                }), w, (0, t.jsxs)("div", {
                    className: "relative bg-accent-crimson/8",
                    children: [(0, t.jsx)("div", {
                        className: "px-16 py-32 text-center",
                        children: (0, t.jsx)("p", {
                            className: "font-mono text-body-large text-accent-black",
                    ...
                    className: "relative",
                    children: [(0, t.jsxs)("div", {
                        className: "px-16 py-24  flex gap-12",
                        children: [(0, t.jsxs)("button", {
                            className: "group inline-flex items-center justify-center rounded-full font-medium transition-all duration-200 h-40 px-20 text-label-medium gap-8 bg-surface text-accent-black border border-black-alpha-8 hover:bg-black-alpha-4 hover:border-black-alpha-12 active:scale-[0.98] flex-1",
                            onClick: () => {
                                p.push(C.createWebRoute.landing.page())
                            },
                            children: [(0, t.jsx)(N, {}), (0, t.jsx)("span", {
                                children: "Go Home"
                            })]
                        }), (0, t.jsx)("button", {
                            className: "inline-flex items-center justify-center rounded-full font-medium transition-all duration-200 h-40 px-20 text-label-medium gap-8 bg-heat-100 text-accent-white hover:bg-heat-200 active:scale-[0.98] shadow-[0_1px_2px_rgba(0,0,0,0.05)] hover:shadow-[0_4px_12px_rgba(250,93,25,0.25)] flex-1",
                            onClick: h,
                            children: "Try Again"
                        })]
                    }), (0, t.jsx)("div", {
                    ...
                    children: [(0, t.jsxs)("div", {
                        className: "flex-1 overflow-y-auto px-16 py-24 font-mono text-body-small text-black-alpha-80 space-y-16",
                        children: [(0, t.jsx)("div", {
                            className: "break-all",
                            children: e.message || "An unexpected error occurred"
                        }), e.digest && (0, t.jsxs)("div", {
                            className: "text-black-alpha-60",
                            children: ["ID: ", e.digest]
                        }), !1]
                    }), (0, t.jsxs)("div", {
                        className: "relative",
                        children: [(0, t.jsx)("div", {
                            ...
                            children: (0, t.jsx)("button", {
                                className: "group inline-flex items-center justify-center rounded-full font-medium transition-all duration-200 h-48 px-24 text-label-large bg-accent-black text-accent-white hover:opacity-90 active:scale-[0.98] shadow-[0_1px_2px_rgba(0,0,0,0.05)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)] dark:bg-accent-white dark:text-accent-black dark:shadow-[0_1px_2px_rgba(0,0,0,0.2)] dark:hover:shadow-[0_4px_12px_rgba(0,0,0,0.25)] w-full overflow-hidden",
                                onClick: j,
                                children: (0, t.jsx)(n.default, {
                                    ...
                                    children: (0, t.jsx)(c.AnimatePresence, {
                                        ...
                                        children: (0, t.jsxs)(d.motion.div, {
                                            ...
                                            children: [(0, t.jsx)("div", {
                                                className: "w-16 h-16",
                                                children: f ? (0, t.jsx)(l.default, {}) : (0, t.jsx)(i.default, {})
                                            }), (0, t.jsx)("span", {
                                                children: f ? "Copied!" : "Copy Error"
                                            })]
                                        }, f ? "copied" : "copy")
                                    })
                                })
                ...
                className: "w-full max-w-[400px] mx-auto relative flex flex-col h-full lg:hidden",
                children: [(0, t.jsx)("div", {
                    className: "absolute left-0 top-0 h-full w-1 bg-border-faint"
                }), (0, t.jsx)("div", {
                    className: "absolute right-0 top-0 h-full w-1 bg-border-faint"
                }), (0, t.jsx)("div", {
                    className: "flex-shrink-0",
                    children: w
                }), (0, t.jsxs)("div", {
                    className: "relative bg-accent-crimson/8 flex-shrink-0",
                    children: [(0, t.jsx)("div", {
                        className: "px-16 py-32 text-center",
                        children: (0, t.jsx)("p", {
                            className: "font-mono text-body-large text-accent-black",
...
//# debugId=47a866aa-389b-7e7e-a371-7a4fbb2b0de9
//# sourceMappingURL=1eb173d4c7902d9a.js.map