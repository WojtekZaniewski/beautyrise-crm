...
function MessagesHubInner({ workspaceId }: { workspaceId: string }) {
  ...
  const renderPanel = () => {
    ...
    if (channelParam === "tiktok") {
      return (
        <div className="flex-1 flex flex-col items-center justify-center text-center gap-3 p-8" style={{ color: "var(--muted)" }}>
          <div className="text-sm max-w-md">
            Oficjalne TikTok Business Messaging API jest niedostępne w Unii Europejskiej. Obsługa wiadomości odbywa się przez TikTok Business Suite.
          </div>
          <a
